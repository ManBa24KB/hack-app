...
const ComLoading = (props: any) => {
    const status: boolean = props.status || false
    const isLoading = useAppSelector((state) => state.loading.isLoading) || status
    ...
    return (
        ...
        >
            <div className="text"><FormattedMessage id='global.loading' defaultMessage=""/>...</div>
