...
import ComLoading from '@/assets/images/comLoading.gif'
...
const ComAddNodeLoading = () => {
    const isLoading = useAppSelector((state) => state.loading.isAddNodeLoading)
...
export default ComAddNodeLoading